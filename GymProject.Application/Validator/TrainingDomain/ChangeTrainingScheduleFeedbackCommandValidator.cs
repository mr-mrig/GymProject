...
namespace GymProject.Application.Validator.TrainingDomain
{
    ...
    public class ChangeTrainingScheduleFeedbackCommandValidator : AbstractValidator<ChangeTrainingScheduleFeedbackCommand>
    {

        public ChangeTrainingScheduleFeedbackCommandValidator(ILogger<ChangeTrainingScheduleFeedbackCommandValidator> logger)
        {
            RuleFor(x => x.Rating)
