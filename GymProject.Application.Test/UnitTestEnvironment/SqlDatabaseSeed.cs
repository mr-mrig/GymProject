...
{
    internal class SqlDatabaseSeed : DatabaseSeed
    {
        ...
        public SqlDatabaseSeed(GymContext context) : base(context) { }
        ...
        public override async Task SeedAthlete()
        {
            ...
            try
            {
                ...
                //athlete.StartTrainingPhase(1, EntryStatusTypeEnum.Private);
                //athlete.StartTrainingPhase(1, EntryStatusTypeEnum.Private, new DateTime(2018, 1, 1), new DateTime(2018, 6, 1));
                //athlete.StartTrainingPhase(2, EntryStatusTypeEnum.Private, new DateTime(2018, 6, 2), new DateTime(2019, 1, 1));
                //athlete.AchieveTrainingProficiency(1);
                //athlete = AthleteRoot.RegisterAthlete(adHocAthleteId,
                ...
                //    //await Context.SaveAsync().ConfigureAwait(false);
                //}               
                for (uint iuser = adHocAthleteId + 1; iuser < Users.Count(); iuser++)
                {
                    athlete = AthleteRoot.RegisterAthlete(iuser);
                    Athletes.Add(athlete);
                    Context.Update(athlete);
                    await Context.SaveAsync().ConfigureAwait(false);
                }
                ...
                athlete.StartTrainingPhase(adHocPhaseId, EntryStatusTypeEnum.Private, DateTime.UtcNow.AddDays(150));
        ...
        public async Task SeedWorkoutTemplate(TrainingPlanRoot plan, 
        ...
        public async Task SeedStandardTestCaseWorkoutTemplate(TrainingPlanRoot plan, float repetitions = 10)
        {
            try
            {
                WorkoutTemplates = new List<WorkoutTemplateRoot>();
        ...
        public async Task SeedDraftPlanWorkoutTemplate(TrainingPlanRoot plan)
        {
