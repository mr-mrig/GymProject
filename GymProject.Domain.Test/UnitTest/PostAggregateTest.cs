...
//        {
//            TimeSpan timePrecision = new TimeSpan(0, 0, 0, 0, 200);
...
//            post.ModifyComment(post.Comments.FirstOrDefault().Id, newComment);
...
//            Assert.Equal(DateTime.Now, post.LastUpdate.Value, timePrecision);
//            Assert.Equal(DateTime.Now, post.Comments.FirstOrDefault().LastUpdate.Value, timePrecision);
...
//            post.RemoveComment(post.Comments.FirstOrDefault().Id);
...
//            post.Unlike(post.Likes.ToList().FirstOrDefault().Id);
