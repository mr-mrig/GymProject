...
namespace GymProject.Domain.TrainingDomain.TrainingPlanAggregate
{
    public class TrainingPlanMuscleFocusRelation : ValueObject
    {
        ...
        /// </summary>
        public IdTypeValue MuscleId { get; private set; } = null;
        ...
        private TrainingPlanMuscleFocusRelation(TrainingPlanRoot trainingPlan, IdTypeValue muscleId)
        {
        ...
        public static TrainingPlanMuscleFocusRelation BuildLink(TrainingPlanRoot trainingPlan, IdTypeValue muscleId)
